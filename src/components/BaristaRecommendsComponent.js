...
const BaristaRecommendsComponent = () => {
  return (
    <div className="p-5 bg-[#edebe9] w-100 mt-14 lg:pl-20 lg:pr-20 pb-10 relative">
      <div className="pt-5 flex justify-between">
        ...
        <span className="text-[#00754a] font-semibold text-sm cursor-pointer">
          View Menu
        </span>
      </div>
      ...
      <div className="mt-10 relative">
        ...
        <div className="swiper-button image-swiper-button-next absolute">
            <img src= "https://www.starbucks.in/swiperbtnright.cbc1d309941ecd98.svg" alt= "next"></img>
        </div>
        <Swiper
        ...
        >
          <SwiperSlide>
            <div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
              <div className="grid grid-cols-[1fr_3fr]">
                <div>
                  <img
                    src="https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/100501.webp"
                    alt="java chip"
                ...
                <div className="p-2">
                  ...
                  <p className="font-semibold">Java Chip Frappuccino</p>
                  <p className="text-xs text-[#6c757d]">
                    {" "}TALL(354 ML) .392 kcal</p>
                </div>
               </div>
               <div className="mt-5 flex justify-between itemms-center">
                <div>
                    <span className="font-semibold text-sm">₹ 351<span className="text-xs">.75</span></span>
                </div>
                <div>
          ...
          <div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
              <div className="grid grid-cols-[1fr_3fr]">
                <div>
                  <img
                    src="https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/105468.webp"
                    alt="Cold coffee"
                    className="rounded-lg h-20 object-cover"
                    width={80}
                  ></img>
          ...
          <div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
              <div className="grid grid-cols-[1fr_3fr]">
                <div>
                  <img
                    src="https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/105000.webp"
                ...
                <div className="p-2">
                  ...
                  <p className="font-semibold">Vanilla Sweet Cream Cold Brew</p>
                  <p className="text-xs text-[#6c757d]">
                    {" "}</p>
                </div>
               </div>
          ...
          <SwiperSlide> <div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
              <div className="grid grid-cols-[1fr_3fr]">
                <div>
                  <img
                    src="https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/100447.webp"
                    alt="Signature Hot Chocolate"
                    className="rounded-lg h-20 object-cover"
                    width={80}
                  ></img>
                </div>
                <div className="p-2">
                  ...
                  <p className="font-semibold">Signature Hot Chocolate</p>
                  <p className="text-xs text-[#6c757d]">
                    {" "}PICCO(180 Ml) .284 kcal</p>
                </div>
               </div>
               <div className="mt-5 flex justify-between itemms-center">
                <div>
                    <span className="font-semibold text-sm">₹ 215<span className="text-xs">.75</span></span>
                </div>
                <div>
                    <button className="border-2 p-2 w-32 rounded-3xl text-white bg-[#00754a]">Add Item</button>
                </div>
...
export default BaristaRecommendsComponent;
